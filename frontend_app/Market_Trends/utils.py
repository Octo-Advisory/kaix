...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/home/marsaiae/frappe-bench/apps/frontend_app/frontend_app/Market_Trends/market_trends.log", encoding="utf-8"),
...
# File-based cache
CACHE_FILE = "/home/marsaiae/frappe-bench/apps/frontend_app/frontend_app/Market_Trends/search_cache.json"
