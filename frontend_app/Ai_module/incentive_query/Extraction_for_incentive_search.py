...
def call_incentive_search(input,chatId):
    ...
    keyword_dict = extract_keywords_from_query(refine_user_input, field_with_description["Query to search Incentives"], module_names_list, llm_70b_vers, "Query to search Incentives", existing_keywords=state["KEYWORDS"])
