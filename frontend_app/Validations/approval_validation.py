...
def approval_validation(param):
    ...
    def parameter_check():
        ...
        if all([area, city, state]) and area != 'None' and city != 'None' and state != 'None':
        ...
        elif (not area or area == 'None') and all([city, state]) and city != 'None' and state != 'None':
        ...
        elif (not area or area=='None') and (not city or city=='None') and state and state!='None':
