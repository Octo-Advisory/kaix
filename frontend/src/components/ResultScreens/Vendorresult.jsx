...
function Vendorresult({ result, source, rerender }) {
  ...
  // console.log(IndividualQuery, JSON.parse(analytics_response?.['Unfiltered All IS Supplier']), 'This is the first check ')
...
// }
 ...
 const storeResultData = async (lastChat, solutions, intension) => {
  ...
  useEffect(() => {
    if ((source === "SolutionScreen" || source === 'FromScratch' || source==='MapComponent')) {
