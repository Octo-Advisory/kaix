                    ...
                    <div className="details w-[75%] flex flex-col">
                        ...
                        <div className="Content flex px-5 py-5 gap-2 text-lg">
                            ...
                            <div className="right flex-1 text-start flex flex-col gap-3">
                                ...
                                <div className="items flex gap-3"><div className="icon flex items-center justify-center">{statusIcon[solution.availability_of_local_transportation]}</div><div className="text">Avaibility Of Local Transportaion</div></div>
