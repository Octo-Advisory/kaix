...
import os
import traceback
from kaix.Ai_module.Feasibility_study.feasibility_study import query_classification
...
def run_feasibility_analysis(file_path, result_docname, user):
    try:
        ...
        with open("/home/mars/frappe-bench/apps/kaix/kaix/Ai_module/Feasibility_study/testlog.txt", "a") as file:
            file.write(f"\nresult:- \n{result}")
