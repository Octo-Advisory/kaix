...
PERSIST_ROOT = "/home/marsaiae/frappe-bench/apps/kaix/kaix/vectors"
...
class AdvancedRAGSystem:
    ...
    def create_advanced_retriever(self, vector_store:dict|str, status:bool, doctype:str):
        ...
        if status:
            ...
            with open("/home/marsaiae/frappe-bench/apps/kaix/kaix/Ai_module/Feasibility_study/testlog.txt", "a") as file:
