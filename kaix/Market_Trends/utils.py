...
from kaix.Market_Trends.prompts import decider_prompt
...
config_file = os.path.join(
    base_dir,
    "frappe-bench/apps/kaix/kaix/Log_management/mars.ini"
)
...
CACHE_FILE = os.path.join(
    base_dir,
    "frappe-bench/apps/kaix/kaix/Market_Trends/search_cache.json"
)
