...
from kaix.Ai_module.vendor_query import (
    Extraction_for_vendor_search as vq,
)
from kaix.Ai_module.vendor_query.schemas import VendorClassificationFailure

from kaix.Ai_module.incentive_query import (
    Extraction_for_incentive_search as iq,
)
from kaix.Ai_module.incentive_query.schemas import IncentiveClassificationFailure

from kaix.Ai_module.approval_query import (
    Extraction_for_approval_search as aq,
)
from kaix.Ai_module.approval_query.schemas import ApprovalClassificationFailure

from kaix.Ai_module.employement_query import (
    Extraction_for_employement_search as eq,
)
from kaix.Ai_module.employement_query.schemas import EmploymentClassificationFailure
